...
def greedy_coin(change):
    ...
    coins = [0.5, 0.25, 0.10, 0.05, 0.01]
    coin_lookup = {0.50:"half dinar", 0.25: "quarter dinar", 0.10: "ten piastres", 0.05: "five piastres", 0.01: "qirsh"}
    coin_dict = {}
    for coin in coins:
        coin_dict[coin] = 0 # initialization all zeros
    for coin in coins:
        while change >= coin: 
            change -= coin 
            coin_dict[coin] += 1
